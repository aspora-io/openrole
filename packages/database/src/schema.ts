...
import { pgTable, uuid, text, timestamp, boolean, integer, pgEnum, json, jsonb, varchar, date, index, uniqueIndex, unique, check } from 'drizzle-orm/pg-core';
...
export const companies = pgTable('companies', {
  ...
  culture_values: json('culture_values').$type<string[]>(),
...
export const jobs = pgTable('jobs', {
  ...
  nice_to_have: json('nice_to_have').$type<string[]>(),
...
// candidateProfilesRelations is defined in models/candidate-profile.ts
// cvDocumentsRelations can be defined when needed (currently commented out to avoid circular imports)
// workExperienceRelations is defined in models/work-experience.ts
// portfolioItemsRelations is defined in models/portfolio-item.ts
