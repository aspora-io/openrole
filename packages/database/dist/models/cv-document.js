 ...
 * @date 2025-09-30
 */
import { pgTable, uuid, varchar, text, integer, boolean, timestamp, jsonb, index, unique, check, pgEnum } from 'drizzle-orm/pg-core';
...
export const cvDocumentHelpers = {
    ...
    isValidFileType: (mimeType) => {
        return Object.values(AllowedMimeTypes).includes(mimeType);
    },
    /**
     ...
     */
    generateDownloadUrl: (cvDocument, baseUrl = '') => {
    ...
    validateScanResults: (scanResults) => {
        ...
        return ((virusDetected === undefined || typeof virusDetected === 'boolean') &&
...
export const cvDocumentQueries = (() => {
    ...
    return {
         ...
         */
        userDocumentsWhere: (profileId) => sql `${cvDocuments.profileId} = ${profileId}`,
        /**
...
export const accessTokenManager = {
     ...
     */
    generateToken: (expiresInHours = 24) => {
...
//# sourceMappingURL=cv-document.js.map